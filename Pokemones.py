Primera = ["bulbasaur", "ivysaur", "venusaur", "charmander", "charmeleon", "charizard",
"squirtle", "wartortle", "blastoise", "caterpie", "metapod", "butterfree",
"weedle", "kakuna", "beedrill", "pidgey", "pidgeotto", "pidgeot", "rattata",
"raticate", "spearow", "fearow", "ekans", "arbok", "pikachu", "raichu",
"sandshrew", "sandslash", "nidoran h", "nidorina", "nidoqueen", "nidoran m",
...
Segunda = ["chikorita", "bayleef",
    ...
    "wooper", "quagsire", "espeon", "umbreon", "murkrow", "slowking", "misdreavous",
...
Sexta = ["chespin", "quilladin", "chesnaught", "fennekin", "braixen",
